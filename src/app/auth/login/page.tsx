  ...
  return (
    <div className="flex min-h-screen items-center justify-center pt-16 pb-16">
      <div className="w-full max-w-md px-4">
        ...
        <form onSubmit={e => { e.preventDefault(); alert("Signed in!"); }} className="mt-8 space-y-6">
          ...
          <button type="submit" className="w-full rounded-md bg-[#d4af37] py-3 text-sm font-semibold uppercase tracking-widest text-black hover:bg-[#b8960f] transition-colors">Sign In</button>
        </form>
